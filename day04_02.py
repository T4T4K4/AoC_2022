...
for elf_pair in source:
    cond1 = elf_pair[2] <= elf_pair[0] <= elf_pair[3]
    cond2 = elf_pair[2] <= elf_pair[1] <= elf_pair[3]
    cond3 = elf_pair[0] <= elf_pair[2] <= elf_pair[1]
    cond4 = elf_pair[0] <= elf_pair[3] <= elf_pair[1]
